...
function OutletsPage() {
  ...
  async function getData() {
    try {
      const response = await axiosInstance.get('/api/v1/pos/outlets/');
  ...
  async function deleteData(id) {
    try {
      await axiosInstance.delete(`/api/v1/pos/outlet-details/${id}/`);
      getData();
    ...
    <div className="page-container-scroll">
      <div className="page-container">
        ...
        <div className="page-header-container row">
          <h1 className="page-title col-xs-12 col-md-6">Outlets</h1>
          <div className="page-header-button-container col-xs-12 col-md-6">
            <Link to="/admin/pos/outlets/new" className="btn btn-primary">
              <span className="mx-1">
                <FaPlus />
              </span>
              Create New Outlet
