...
function EditProductPage() {
  ...
  async function sendData(data, e) {
    ...
    try {
      const response = await axiosInstance.put(
        `api/v1/inventory/product-details/${previousData.id}/`,
        data
      );
  ...
  useEffect(() => {
    ...
    previousData.featured_image &&
      setFeaturedPreviewImage(previousData.featured_image);
    previousData.product_image1 &&
      setProductPreviewImages([previousData.product_image1]);
  ...
  return (
    <div className="page-container-scroll">
      <div className="page-container">
        ...
        <Link
          to={{ pathname: `variants`, state: previousData }}
          className="btn btn-primary"
        >
          <span>
            <HiDotsVertical />
