...
import { FaRegFileAlt, FaSearch, FaCaretDown } from 'react-icons/fa';
...
function CurrentInventoryReportsPage() {
  //state
  ...
  useEffect(() => {
    ...
    (async function getData() {
      try {
        ...
        setIsLoading(false);
        errorToast('Error on loading inventory report!, Please try again.');
      }
    })();
    //CSV
    const tempHeader = [];
...
export default CurrentInventoryReportsPage;
