...
function StoreConversionRateOverTimePage() {
  ...
  useEffect(() => {
    ...
    (async function getData() {
      try {
        const response = await axiosInstance.get('api/v1/inventory/dummy/');
        ...
        setIsLoading(false);
        errorToast('Error on loading conversion report!, Please try again.');
      }
    })();
    //CSV
    const tempHeader = [];
      ...
      <div className="page-container">
        ...
        <div className="page-header-container row">
          ...
          <div className="page-header-button-container col-xs-12 col-md-6">
            ...
            <ul className="dropdown-menu" aria-labelledby="period">
              <li>
                  ...
                  >
                    ...
                    <tbody {...getTableBodyProps()}>
                      <tr>
                        ...
                        <td className="bold text-center">0</td>
                        <td className="bold text-center">0</td>
                        <td className="bold text-right">0</td>
                        <td className="bold text-right">0</td>
                        <td className="bold text-right">0%</td>
                      </tr>
                      {page.map((row, i) => {
...
export default StoreConversionRateOverTimePage;
