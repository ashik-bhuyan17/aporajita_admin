...
import { FaCaretDown, FaRegCalendarAlt, FaRegFileAlt } from 'react-icons/fa';
...
function SalesOverTimeReportPage() {
  ...
  useEffect(() => {
    ...
    (async function getData() {
      try {
        ...
        setIsLoading(false);
        errorToast(
          'Error on loading sales over time report!, Please try again.'
        );
      }
    })();
    //CSV
...
export default SalesOverTimeReportPage;
